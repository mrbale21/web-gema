...
import TrainingDetailDashboard from "./TrainingDetail";
import TrainingBenefitPage from "./TrainingBenefit";
...
export default function TrainingDashboard() {
  ...
  const handleUpdate = async (e: React.FormEvent) => {
    ...
    try {
      const res = await fetch(`/api/training/${selectedTraining.id}`, {
        method: "PUT",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({ title, desc, icon }),
      });
  ...
  return (
    <div className="min-h-screen text-gray-800">
      ...
      <div className="flex justify-between items-center mb-6">
        <h1 className="text-3xl font-bold"> Keunggulan Pelatihan</h1>
        <button
